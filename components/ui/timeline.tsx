        ...
        content: (
          ...
          >
            ...
            <p className="font-medium my-4 main text-neutral-800 text-lg leading-relaxed">
              Ascent, Our robot for the 2024 season competing in the 2024
              season, excelled at scoring and climbing. We were rank #25 in 2024
              NYC Regionals.
            </p>
            <div className="mt-8">
        ...
        content: (
          ...
          >
            ...
            <p className="font-medium my-4 main text-neutral-800 text-lg leading-relaxed">
              ...
              about our team's mission, events, and how we design and build
              robots for global competitions.
            </p>
            <div className="my-6">
      ...
      },
      {
        ...
        content: (
          ...
          >
            ...
            <div className="my-6">
              <Link href="https://github.com/team334/castle">
                <Button
                  ...
                  className="font-bold main text-center px-8 py-6 text-lg bg-gradient-to-r from-blue-500 to-purple-500 hover:opacity-90"
                  onMouseEnter={() =>
                    handleButtonHover("scouting-app-btn", true)
                  }
                  onMouseLeave={() =>
            ...
            <ProjectImage
              src="/scouting-app.png"
              alt="Scouting App Screenshot"
            />
          </motion.div>
        ),
      },
      {
        ...
        content: (
          ...
          >
            ...
            <p className="font-medium my-4 main text-neutral-800 text-lg leading-relaxed">
              A Discord bot that allows us to get the latest news and updates
              from Chief Delphi.
            </p>
            <div className="my-6">
      ...
      },
      {
        ...
        content: (
          ...
          >
            ...
            <p className="font-medium my-4 main text-neutral-800 text-lg leading-relaxed">
              A free analytics tool for chess user who want to analyze their
        ...
        content: (
          ...
          >
            ...
            <p className="font-medium my-4 main text-neutral-800 text-lg leading-relaxed">
              ...
              are paintings in an art gallery and calculates the minimum number
              of guards needed to watch over all the paintings. It also provides
              a visual representation of the guards' coverage areas.
            </p>
            <div className="my-6">
              <Link href="https://github.com/cherriae/GT-Art-Gallery">
                <Button
                  ...
                  className="font-bold main text-center px-8 py-6 text-lg bg-gradient-to-r from-blue-500 to-purple-500 hover:opacity-90"
                  onMouseEnter={() =>
                    handleButtonHover("art-gallery-btn", true)
                  }
                  onMouseLeave={() =>
                    handleButtonHover("art-gallery-btn", false)
                  }
                >
                  Link to Github
                  <motion.div
      ...
      },
      {
        ...
        content: (
          ...
          >
            ...
            <p className="font-medium my-4 main text-neutral-800 text-lg leading-relaxed">
              A website for National History Day on the Haitian Revolution and
              its enduring continuities through the lens of many different
              perspectives.
            </p>
            <div className="my-6">
      ...
      },
      {
        ...
        content: (
          ...
          >
            ...
            <p className="font-medium my-4 main text-neutral-800 text-lg leading-relaxed">
              A shot planner for the FRC 2026 Rebuilt robot, designed to
              optimize shot angle and velocity for maximum efficiency.
            </p>
            <div className="my-6">
              <Link href="https://github.com/cherriae/shotPlanner2025">
                <Button
                  ...
                  className="font-bold main text-center px-8 py-6 text-lg bg-gradient-to-r from-blue-500 to-purple-500 hover:opacity-90"
                  onMouseEnter={() =>
                    handleButtonHover("shot-planner-btn", true)
                  }
                  onMouseLeave={() =>
        ...
        content: (
          ...
          >
            ...
            <p className="font-medium my-4 main text-neutral-800 text-lg leading-relaxed">
              ...
              Fermat's Last Theorem by showing that there are no integer
              solutions for a^n + b^n = c^n when n {">"} 2.
            </p>
            <div className="my-6">
              <Link href="https://github.com/cherriae/NT-Project">
                <Button
                  ...
                  onMouseLeave={() =>
                    handleButtonHover("nt-project-btn", false)
                  }
                >
                  Link to Github
                  <motion.div
      ...
      },
      {
        ...
        content: (
          ...
          >
            ...
            <p className="font-medium my-4 main text-neutral-800 text-lg leading-relaxed">
              A game that simulates the Harlem Renaissance and key figures of
              the Roaring Twenties, allowing players to explore the rich culture
              of the Harlem Renaissance through a big map.
            </p>
            <div className="my-6">
